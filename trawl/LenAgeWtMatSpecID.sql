...
select
       ...
       h.Operation_Status,
       a.age_specimen_num,
       st_spc.stomach_sample_number,
       st_spc.stomach_sampling_plan,
       st_spc.tissue_sample_number,
       st_spc.tissue_sampling_plan,
       st_spc.finclip_blotter_number,
       st_spc.finclip_sampling_plan
...
left join master.vw_indiv_standard_specimen st_spc
on st_spc.individual_id = a.individual_id
